...
describe('HamSwapV2Router02', () => {
  ...
  //     'HamSwapV2Library: INSUFFICIENT_INPUT_AMOUNT'
  //   )
  ...
  //     'HamSwapV2Library: INSUFFICIENT_OUTPUT_AMOUNT'
  //   )
...
//     pair = new Contract(pairAddress, JSON.stringify(IHamSwapV2Pair.abi), provider).connect(wallet)
//     virt = fixture.virt
//   })
