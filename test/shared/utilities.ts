...
export const DELAY = 60 * 60 * 24 * 2 // two days
...
export function getCreate2Address(
  ...
  [tokenA, tokenB, virt]: [string, string, string],
  bytecode: string
): string {
  ...
  const create2Inputs = [
    '0xff',
    factoryAddress,
    utils.keccak256(utils.solidityPack(['address', 'address', 'uint256'], [token0, token1, virt])),
